        ...
        <div>
            ...
            <section className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-2  gap-4">
                    ...
                    <div className="bg-white dark:bg-gray-500 p-6 rounded-lg shadow-md text-center">
                        <h3 className="text-xl/8 md:text-2xl/8 font-bold"><span className="text-6xl text-[#78176f]">8</span> Faculties</h3>
                    </div>
                    <div className="bg-white dark:bg-gray-500 p-6 rounded-lg shadow-md md:col-span-2 flex justify-center items-center gap-2">
