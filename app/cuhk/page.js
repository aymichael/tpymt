...
export default function CUHKPage() {
    return (
        <div>
            <h1 className="text-4xl font-bold text-[#78176f] text-center mb-8">The Chinese University of Hong Kong</h1>

            {/* Introduction Section */}
            <section className="mb-8">
                <h2 className="text-2xl font-bold mb-4 text-[#78176f]">About CUHK</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-bold mb-4 text-[#78176f]">CHUK Rankings and Figures</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-2  gap-4">
                    <div className="bg-white p-6 rounded-lg shadow-md text-center"><h3 className="text-xl font-bold"><span className="text-6xl text-[#78176f]">4</span> Nobel Laureates</h3>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md text-center">
                        <h3 className="text-xl font-bold"><span className="text-6xl text-[#78176f]">8</span> Faculties</h3>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md md:col-span-2 flex justify-center items-center gap-2">
                        <span class="text-6xl text-[#78176f] font-bold">5</span>
                        <h3 class="text-xl font-bold max-w-prose">
            ...
            <section className="mb-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl font-bold mb-2 text-ce">QS World University Rankings</h3>
                        <p className="text-gray-800">6th in Asia / 36th in the World</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl font-bold mb-2">Times Higher Education World University Rankings</h3>
                        <p className="text-gray-800">10th in Asia / 44th in the World</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl font-bold mb-2">Reuters Asia&apos;s Most Innovative University</h3>
                    ...
                    <div className="flex-col md:flex-row md:col-span-3 flex justify-center gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-1/2 lg:w-1/3">
                            <h3 className="text-xl font-bold mb-2">U.S. World Patents Granted</h3>
                            <p className="text-gray-800">2nd in Hong Kong / 79th in the World</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-1/2 lg:w-1/3">
                            <h3 className="text-xl font-bold mb-2">Shanghai Ranking&apos;s Academic Ranking of World Universities</h3>
