    ...
    return (
        <div className="">
            ...
            <div className="grid grid-cols-2 gap-x-32 gap-y-4">
                <div className="bg-yellow-500 dark:bg-yellow-800 px-8 py-4 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white">
                    <h2 className="text-xl/8 md:text-2xl/8 font-bold text-center md:text-nowrap">Theoretical Knowledge</h2>
                </div>
                <div className="bg-lime-600 dark:bg-lime-800 px-8 py-4 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white">
                    <h2 className="text-xl/8 md:text-2xl/8 font-bold text-center md:text-nowrap">Future Learning Path</h2>
                </div>
                ...
                <div className="bg-lime-100 dark:bg-lime-800 px-8 py-4 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white flex flex-col justify-center">
                ...
                <div className="bg-amber-100 dark:bg-amber-800 px-8 py-4 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white flex flex-col justify-center">
