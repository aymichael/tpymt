        ...
        <div className="">
            ...
            <ArcherContainer>
                <div className="grid grid-cols-2 gap-x-24 lg:gap-x-32 gap-y-4">
                    <div className="bg-yellow-500 dark:bg-yellow-800 px-8 py-4 rounded-lg text-gray-900 dark:text-white flex justify-center">
                        <h2 className="text-xl/8 md:text-2xl/8 font-bold md:text-nowrap">Theoretical Knowledge</h2>
                    </div>
                    <div className="bg-lime-600 dark:bg-green-800 px-8 py-4 rounded-lg text-gray-900 dark:text-white flex justify-center">
                    ...
                    <ArcherElement
                        ...
                        <div className="bg-amber-200 dark:bg-amber-800 px-8 py-4 rounded-lg text-gray-900 dark:text-white flex flex-col justify-center">
                    ...
                    <ArcherElement
                        id="right-1"
                    >
                        <div className="bg-lime-100 dark:bg-lime-700 px-8 py-4 rounded-lg text-gray-900 dark:text-white flex flex-col justify-center">
                    ...
                    >
                        <div className="bg-amber-100 dark:bg-amber-700 px-8 py-4 rounded-lg text-gray-900 dark:text-white flex flex-col justify-center">
                    ...
                    <ArcherElement
                        id="right-2"
                    >
                        <div className="bg-lime-200 dark:bg-lime-800 px-8 py-4 rounded-lg text-gray-900 dark:text-white flex flex-col justify-center">
